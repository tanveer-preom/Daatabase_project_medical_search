            ...
            <section class="search-result" style="margin-left:60px">
               ...
               $rotated =1;   
                foreach ($results as $row ) {
                    ...
                    if($rotated ==1)
                    {
                        echo '<h2>'.count($results).' Search results found for '.$row->TestName.'</h2>';
                        $rotated = 0;   
                    }
                    echo '<hr>
               <div>
                    <a href="details?t_id='.$row->test_id.'&d_id='.$row->diagId.'"><b style="color : blue;font-size: 170%;">'.$row->DiagName.'</b></a>
                    <br>
                    <b>Price : '.$row->DiagPrice.'TK</b>
                    <br>
                    <b>Location : shubidbazaar,Sylhet</b>
               </div> 
               <hr>
               ';
                }
               ...
               ?>
               <form action="results" method="post" style="width: 500px; margin-left:30%;margin-right:30%">
